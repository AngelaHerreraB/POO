...
public class Calificaciones {
    ...
    public void MostrarBaja(Calificaciones[] califs) {
        int aux = 0;
        ...
        System.out.println("Calificacion mas baja: " + califs[aux] + "\nMateria" + califs[aux].getMateria());
    }

    public void MostrarAlta(Calificaciones[] califs) {
        int aux = 0;
        for (int i = 1; i < califs.length; i = i + 1) {
            if (califs[i].getCalificacion() > califs[aux].getCalificacion()) {
                aux = i;
        ...
        System.out.println("Calificacion mas alta: " + califs[aux] + "\nMateria" + califs[aux].getMateria());
    }

    public void MostrarProm(Calificaciones[] califs) {
        float promedio = 0;
